...
2. **Generate tokens using script**
   ```bash
   python scripts/design_token_generator.py ""#0066CC"" --style modern --format json
   ```
...
4. **Export in target format**
   ...
   python scripts/design_token_generator.py ""#0066CC"" --style modern --format css > design-tokens.css

   # SCSS variables
   python scripts/design_token_generator.py ""#0066CC"" --style modern --format scss > _design-tokens.scss

   # JSON for Figma/tooling
   python scripts/design_token_generator.py ""#0066CC"" --style modern --format json > design-tokens.json
   ```
...
1. **Export tokens in required formats**
   ```bash
   # For CSS projects
   python scripts/design_token_generator.py ""#0066CC"" --style modern --format css

   # For SCSS projects
   python scripts/design_token_generator.py ""#0066CC"" --style modern --format scss
...
python scripts/design_token_generator.py ""#8B4513"" --style classic --format css

# Playful style summary view
python scripts/design_token_generator.py ""#FF6B6B"" --style playful --format summary
```
