...
description: "Algotic Claude skill for routed creative ideation. Use for brainstorming, stuck projects, idea selection, subversion, refinement, synthesis, product, writing, research, or software ideas."
---

# Creative Ideation

Algotic adaptation for Claude. Use this skill as a routed creative-method library for Claude Code or Claude custom skills; load only the referenced method or reference file needed for the user's prompt.
