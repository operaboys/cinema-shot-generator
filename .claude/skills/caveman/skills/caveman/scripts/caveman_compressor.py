...
PLEASANTRIES_PHRASES = [
    ...
    "of course!", "of course,",
    "i'd be happy to help you with that.", "i would be happy to help you with that.",
...
def _drop_phrases(text: str, phrases: List[str]) -> str:
    # Longest-match-first: without this, a short phrase nested inside a
    # longer one (e.g. "happy to help" inside "i'd be happy to help you
    # with that") can match first and strip only the middle of the
    # sentence, leaving broken grammar ("I'd be you with that.") instead
    # of letting the longer, more complete phrase match as a whole.
